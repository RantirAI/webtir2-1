...
export const HeadingSettingsPopover: React.FC<HeadingSettingsPopoverProps> = ({
  ...
  return (
    ...
    >
      {/* Header - Draggable */}
      <div className="popover-header flex items-center justify-between px-2 py-1.5 border-b border-border cursor-grab active:cursor-grabbing">
      ...
      <div className="p-2 space-y-2">
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            className="bg-muted border-border text-foreground placeholder:text-muted-foreground h-7 text-xs"
          />
        </div>
        ...
        <Button
          ...
          variant="ghost"
          className="w-full h-7 justify-between text-xs text-muted-foreground hover:text-foreground hover:bg-muted"
        >
          Show All Settings
