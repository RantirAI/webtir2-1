...
export const SheetDataEditor: React.FC<SheetDataEditorProps> = ({ instance }) => {
  ...
  return (
    <div className="space-y-3">
      <label className="text-[10px] font-medium text-foreground">Sheet Settings</label>
      
      <div className="space-y-1">
        <label className="text-[9px] text-muted-foreground">Trigger Text</label>
        <Input
          value={instance.props?.trigger || 'Open Sheet'}
          onChange={(e) => updateProps({ trigger: e.target.value })}
          className="h-5 text-[10px]"
          placeholder="Button text to open sheet"
        />
      </div>
      ...
      <div className="space-y-1">
        ...
        <Input
          value={instance.props?.title || 'Sheet Title'}
      ...
      <div className="space-y-1">
        ...
        <Textarea
          value={instance.props?.description || 'Sheet description goes here.'}
      ...
      <div className="space-y-1">
        ...
        <select
          ...
          value={instance.props?.side || 'right'}
